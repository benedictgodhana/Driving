    ...
    <AdminLayout>
      <v-col cols="12">
        ...
        <v-card max-width="1900" elevation="0" width="100%">
          ...
          >
            <template v-slot:top>
              <!-- Add any top content for the table here if needed -->
            </template>
            <template v-slot:item.actions="{ item }">
              ...
              <v-chip icon color="white" @click="openDialog('delete', item)" elevation="0">
  ...
  export default {
    ...
    methods: {
      openDialog(type, user) {
        this.selectedUser = { ...user, profile: user.profile || {} };
